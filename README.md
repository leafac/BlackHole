...
- Works on macOS 10.10+ including macOS Big Sur
...
Install via Homebrew `brew cask install blackhole-2ch` (2-channel version) or `brew cask install blackhole-16ch` (16-channel version)
